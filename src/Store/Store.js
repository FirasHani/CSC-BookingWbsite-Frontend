...
const headers = [
  { name: 'Store Name', styles: 'min-w-[280px]' },
  { name: 'Location', styles: 'min-w-[280px]' },
  { name: 'Lable', styles: 'min-w-[250px]' },
  { name: 'Latitude', styles: 'min-w-[140px]' },
  { name: 'Longitude', styles: 'min-w-[140px]' },
]
      ...
      <div className='container mx-auto'>
        <div className='-mx-4 flex flex-wrap'>
          <div className='w-full px-4'>
            <div className='w-[1200px] overflow-x-auto bg-white dark:bg-dark-2 shadow-[10px_10px_10px_10px_rgba(0,0,0,0.08)] rounded-xl'>
