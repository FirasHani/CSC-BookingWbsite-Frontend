...
const ChatList = () => {
  ...
  return (
    <section className="bg-gray-2 py-[90px]">
      <div className="mx-auto px-4 md:container">
        <div className="mx-auto max-w-[700px] rounded-lg bg-white shadow-1">
          <div className="border-b border-stroke p-5">
            <h3 className="text-xl font-medium text-dark">
              <span>Active Conversations</span>
              <span className="ml-4 rounded-md border-[.5px] border-stroke bg-[#F8FAFC] px-[10px] py-[2px] text-base font-medium text-dark">
                7
              </span>
            </h3>
          </div>
          ...
          <div className="p-5">
            <form className="relative mb-7">
              <input
                type="text"
                className="w-full rounded-md border border-stroke bg-transparent py-3 pl-5 pr-10 text-base text-body-color outline-none focus:border-primary"
                placeholder="Search..."
              />
              <button className="absolute right-4 top-1/2 -translate-y-1/2 text-body-color hover:text-primary">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
            ...
            <div className="space-y-[10px]">
              ...
              <ChatItem
                ...
                name="Cody Fisher"
                text="I'm waiting for your response!"
              />
              <ChatItem
                active
...
const ChatItem = ({ img, name, text, active }) => {
  return (
    <div className="flex cursor-pointer items-center rounded-[5px] px-4 py-[10px] hover:bg-gray-1">
      <div className="relative mr-[14px] h-15 w-full max-w-[44px] rounded-full">
        <img
          src={img}
          alt="profile"
      ...
      <div className="w-full">
        <h5 className="text-sm font-medium text-dark">{name}</h5>
        <p className="text-xs text-dark">{text}</p>
      </div>
    </div>
  );
};
