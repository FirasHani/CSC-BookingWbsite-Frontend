...
const VerticalNavbar4 = () => {
  return (
    <section className="h-screen bg-gray-400	 ">
      <div className="flex h-screen w-full lg:max-w-[300px]  flex-col justify-between overflow-y-scroll bg-gray-1 ">
        <div>
        ...
        <div className="px-6 py-10">
          <div className="flex items-center rounded-[10px] bg-white px-[18px] py-4 shadow-1 ">
  ...
  return (
    <li className="relative">
      <a
        ...
        } group relative mb-[2px] flex items-center rounded px-4 py-[10px] text-base font-medium text-body-color duration-200 hover:bg-primary  `}
      >
        <span className="pr-[10px]">{icon}</span>
        {menu}
        {message && (
          <span className="ml-4 rounded-full bg-primary px-[10px] py-1 text-xs font-semibold  group-hover:bg-white group-hover:text-primary">
            {message}
          </span>
        )}
        {submenu && (
